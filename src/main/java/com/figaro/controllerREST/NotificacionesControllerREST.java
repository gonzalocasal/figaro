...
public class NotificacionesControllerREST {
	...
	@DeleteMapping("notificaciones/eliminar/todas")
    public ResponseEntity<?> deleteAll() {
		service.deleteAll();
		return new ResponseEntity<>( HttpStatus.OK);
    }
	
	@DeleteMapping("notificaciones/eliminar/{notificacionId}")
    public ResponseEntity<?> delete(@PathVariable int notificacionId) {
		service.delete(notificacionId);
		return new ResponseEntity<>( HttpStatus.OK);
    }
